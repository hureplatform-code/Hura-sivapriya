      ...
      <div className="space-y-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            <button className="flex items-center gap-2 px-6 py-3 bg-slate-100 text-slate-600 font-medium rounded-xl hover:bg-slate-200 transition-all border border-slate-200 shadow-sm active:scale-95">
              <History className="h-5 w-5" />
              Dispense Log
            </button>
            <button className="flex items-center gap-2 px-6 py-3 bg-primary-600 text-white font-medium rounded-xl hover:bg-primary-700 transition-all shadow-lg shadow-primary-200 active:scale-95">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-6">
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <div className="flex gap-2">
              <select className="px-4 py-3 bg-slate-50 border-none focus:ring-2 focus:ring-primary-100 rounded-xl text-sm transition-all outline-none text-slate-600 font-medium appearance-none min-w-[140px]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {inventory.map((item, i) => (
                ...
                >
                  ...
                  <p className="text-xs text-slate-400 font-semibold uppercase mt-1 tracking-tighter">{item.category}</p>
                  
                  <div className="mt-6 flex items-end justify-between">
                    <div>
                      <p className="text-2xl font-semibold text-slate-900 leading-none">{item.stock}</p>
                        ...
                        {activeMenu === item.id && (
                          <>
                            ...
                            >
                              ...
                              <button className="w-full flex items-center gap-3 px-4 py-2.5 text-sm font-medium text-amber-600 hover:bg-amber-50 transition-colors">
