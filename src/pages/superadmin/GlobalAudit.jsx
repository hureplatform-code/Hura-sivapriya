        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
           ...
           <div className="space-y-6">
              <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm space-y-6">
                 <div>
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-3 block">Search Events</label>
                    <div className="relative">
                       ...
                       <input 
                         ...
                         className="w-full pl-10 pr-4 py-3 bg-slate-50 border-none focus:ring-2 focus:ring-primary-100 rounded-xl text-sm font-bold transition-all outline-none"
                       />
                    </div>
                 </div>
              ...
              <div className="bg-slate-900 rounded-3xl p-6 text-white space-y-4 shadow-xl overflow-hidden relative">
                 <div className="relative z-10">
                    <h4 className="text-sm font-black tracking-tight mb-2">Compliance Alert</h4>
           ...
           <div className="lg:col-span-3 space-y-4">
              {loading ? (
                <div className="p-20 text-center text-slate-400 font-bold uppercase tracking-widest text-xs italic">Parsing global event stream...</div>
                ...
                <div className="bg-white p-20 rounded-3xl border border-slate-100 shadow-sm text-center">
                   ...
                   <h3 className="text-slate-900 font-black">No Audit Events</h3>
                      ...
                      <div className="flex-1 min-w-0">
                         <div className="flex items-center justify-between mb-1">
                            <div className="flex items-center gap-3">
                               ...
                               <span className={`px-2 py-0.5 rounded-md text-[9px] font-black uppercase tracking-widest border ${getModuleColor(log.module)}`}>
                                 {log.module}
                               </span>
                            </div>
